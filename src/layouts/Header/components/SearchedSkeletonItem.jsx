function SearchedSkeletonItem() {
  return (
    <article
      role="status"
      className="animate-pulse space-y-8 md:flex md:items-center md:space-x-8 md:space-y-0 rtl:space-x-reverse"
    >
      <div className="flex h-16 w-12 items-center justify-center rounded bg-gray-300 sm:w-52 dark:bg-gray-700">
        <svg
...
export default SearchedSkeletonItem;
